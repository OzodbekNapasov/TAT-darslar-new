...
export function QuizSection({
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-6 rounded-2xl border-2 border-purple-edge bg-surface p-6 shadow-sm sm:p-8">
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="mb-2 flex items-center gap-2.5 text-xs font-bold uppercase tracking-wider text-purple-ink sm:text-sm">
            ...
            <h2 className="text-xl font-black leading-tight text-fg sm:text-2xl">
              2-Dars bo‘yicha test sinovlari
            </h2>
          ...
          <div className="flex w-full shrink-0 items-center justify-between gap-4 rounded-xl border border-line bg-subtle p-4 md:w-auto md:justify-start">
            <div>
              ...
              <span className="text-xl font-black text-purple-ink">
            ...
            {answered > 0 && (
              <button
                ...
                className="flex cursor-pointer items-center gap-1.5 rounded-lg border border-purple-edge bg-purple-tint px-4 py-2 text-xs font-bold text-purple-ink transition-all hover:bg-purple-tint-strong"
              >
            ...
            <div
              ...
              className={`rounded-2xl border-2 bg-surface p-6 shadow-sm transition-all sm:p-7 ${
                isAnswered
                  ...
                  : 'border-line hover:border-purple-edge'
              }`}
            >
              <div className="mb-4 flex items-start justify-between gap-4">
                <div className="flex items-start gap-3.5">
                  <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-xl border border-purple-edge bg-purple-tint-strong text-sm font-bold text-purple-ink">
                    {qIndex + 1}
                  </span>
              ...
              <div className="mt-4 space-y-3 pl-0 sm:pl-11">
                {order.map((optIdx, pos) => {
                  ...
                  let optClass =
                    'border-line bg-subtle hover:bg-purple-tint/50 hover:border-purple-edge text-fg';
      ...
      {/* result card */}
      {answered === total && (
        <div className="space-y-5 rounded-3xl border-2 border-purple-600 bg-surface p-6 text-center shadow-md sm:p-10">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border-2 border-purple-edge bg-purple-tint-strong text-purple-ink">
            <Award className="h-9 w-9" />
          </div>

          <div>
            <span className="rounded-full border border-purple-edge bg-purple-tint-strong px-3.5 py-1 text-xs font-bold uppercase tracking-wider text-purple-ink">
          ...
          <div className="mx-auto grid max-w-lg grid-cols-3 gap-4 rounded-2xl border border-line bg-subtle p-5">
            ...
            <div>
              ...
              <div className="text-2xl font-black text-purple-ink">{percent}%</div>
            </div>
            <div>
          ...
          <div className="flex flex-wrap justify-center gap-3 pt-2">
            <button
              type="button"
              onClick={() => onReset(quizSet)}
              className="inline-flex cursor-pointer items-center gap-2 rounded-xl bg-purple-600 px-6 py-3 text-base font-bold text-white shadow-sm transition-colors hover:bg-purple-700"
            >
            ...
            {otherBank &&
              Object.keys(answers[otherBank.key]).length <
                ...
                <button
                  ...
                  className="inline-flex cursor-pointer items-center gap-2 rounded-xl border border-purple-edge bg-subtle px-6 py-3 text-base font-bold text-purple-ink transition-colors hover:bg-purple-tint"
                >
